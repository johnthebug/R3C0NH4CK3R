...
sudo pip3 install -r ~/tools/R3C0NH4CK3R/sources/github-search/requirements.txt
sudo pip3 install -r ~/tools/R3C0NH4CK3R/sources/github-search/requirements2.txt
sudo pip3 install -r ~/tools/R3C0NH4CK3R/sources/github-search/requirements3.txt
...
rm P4R4M-HUNT3R.zip
pip3 install -r ~/tools/R3C0NH4CK3R/sources/P4R4M-HUNT3R/requirements.txt
pip install -r ~/tools/R3C0NH4CK3R/sources/P4R4M-HUNT3R/requirements.txt
